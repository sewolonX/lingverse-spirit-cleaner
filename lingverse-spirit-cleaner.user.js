    ...
    var BUILTIN_CHANGELOG = [
        {
            version: '1.3.9',
            title: '全新微信通知系统',
            notes: ['清理开始/清理中(10min)/冥想/高级冥想/死亡/复活/清理统计通知', '每10分钟推送剩余神识，每20分钟推送冥想进度', '清理结束推送完整统计（探索次数/遭遇/死亡/修为变化）']
        },
        {
            version: '1.3.5',
            title: '铭文系统全面重写',
            notes: ['改为纯API调用，装备从法相穿搭读取，品质下拉凡纹~天纹', '修复statType/天纹值/属性名匹配，百连日志只显示最优3条', '复活下拉从游戏地图弹窗抓取地名，死亡后API自动跳转', '百连模式、屏蔽更新提醒']
        },
        {
            version: '1.3.0',
            title: '操作逻辑大优化',
            notes: ['清理↔监测自动衔接，复活后自动恢复HP/MP', '战斗后检查血量自动恢复，buff连续失败自动关闭', '藏宝图/试炼/铭文完成后自动切探索', '道韵自定义弹窗、复活前往下拉框']
        },
        {
            version: '1.2.0',
            title: '大版本更新',
            notes: ['铭文天纹适配(R1~R7)、商人品质购买、引渡复活区域', '回血回蓝排序、企业微信三通道、世界聊天转发', '自动收徒/徒弟请求处理、通知事件']
        }
    ];
